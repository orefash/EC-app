...
var validateExpectedParameters = function validateExpectedParameters(options) {
    var expectedParameters = ['botId', 'token', 'userId'];
...
var getBlockIdOrNameFromOptions = function getBlockIdOrNameFromOptions(options) {
...
var broadcast = function broadcast(options) {
    ...
    var chatfuelRedirectBlock = getBlockIdOrNameFromOptions(options);
    ...
    }, chatfuelRedirectBlock, attributes);
